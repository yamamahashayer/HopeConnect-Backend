...
public class Sponsor {
    ...
    public int getTotalSponsoredOrphans() {
        return totalSponsoredOrphans;
    }

    public void setTotalSponsoredOrphans(int totalSponsoredOrphans) {
        this.totalSponsoredOrphans = totalSponsoredOrphans;
    }
    ...
    public LocalDate getSponsorshipStartDate() {
        return sponsorshipStartDate;
    }

    public void setSponsorshipStartDate(LocalDate sponsorshipStartDate) {
    ...
    public void setSponsorStatus(SponsorStatus sponsorStatus) {
